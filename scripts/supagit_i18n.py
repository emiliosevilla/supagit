...
_MESSAGES: dict[str, dict[str, str]] = {
    "en": {
        ...
        "config_synced": "Project configuration synchronized: {path}",
        "dry_run_config_sync": "DRY-RUN: would synchronize project configuration: {path}",
    ...
    "es": {
        ...
        "config_synced": "Configuración del proyecto sincronizada: {path}",
        "dry_run_config_sync": "DRY-RUN: se sincronizaría la configuración del proyecto: {path}",
